  ...
  return (
    <div className="aboutme-root w-full dark:bg-slate-900 py-40">
      <div className="aboutme-wrapper w-11/12 md:w-[750px] mx-auto h-[600px] md:h-[550px] relative">
        <div className="about-image absolute w-[300px] h-[350px] md:w-[350px] md:h-[400px] left-0 top-0 rounded-3xl overflow-hidden bg-red-500">
        ...
        <div className="about-desc dark:text-slate-100 absolute dark:bg-slate-800 w-[300px] h-[350px] md:w-[450px] md:h-[400px] bg-white right-0 bottom-0 rounded-3xl shadow-lg local-primary-font p-8 flex flex-col justify-between items-start">
          <div className="aboutme-header text-2xl font-bold text-slate-900 inline-block">
            {aboutMeHeader}
          </div>
          ...
          <a
            href={"#Link"}
            className="local-primary-font rounded-md bg-blue-400 hover:bg-blue-300 py-2 px-4 text-white transition-all font-bold flex justify-center items-center gap-2"
          >
